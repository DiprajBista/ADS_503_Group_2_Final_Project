...
# Calculate a 21 day moving average
...
ggplot(nflx_df, aes(x = Date)) +
  ...
  scale_color_manual(values = c("Adjusted Close" = "blue", "21 Day Moving Average" = "red")) +
...
ggplot(nflx_df, aes(x = Date)) +
  ...
  scale_fill_manual(values = c("Weekly Volume" = "orange")) +
